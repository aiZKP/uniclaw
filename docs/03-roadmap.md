...
Phase 3.5 🚧 hardening + adoption foundations (steps 19 + 20 + 20a + 21 + 22 landed; key_id + tool-execution API + Python/Go clients queued)  ← you are here
Phase 3 ⬜ planned
Phase 4 ⬜ planned
Phase 5 ⬜ planned
Phase 6 ⬜ planned
